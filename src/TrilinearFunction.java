...
public class TrilinearFunction extends LinearModule
{
    ...
    public TrilinearFunction(TriFunction<Double,Double,Double,Double>function)
    {
        this.function=function;
    }
    public TrilinearFunction(LinearModule input1,LinearModule input2,LinearModule input3,TriFunction<Double,Double,Double,Double>function)
    {
        this.input1=input1;
        this.input2=input2;
        this.input3=input3;
    ...
    {
        return new TrilinearFunction(x,y,α,rOutpost::blend);
    }
    //endregion
}
